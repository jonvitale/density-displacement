	...
	p.redraw = function(highlightColor)
	{
		...
		for (i = 0; i < this.cubes_projected2d.length; i++)
		{
			if (this.cubes_projected2d[i] != null)
			{
				...
				if (this.is_container && (typeof(this.belowBlock) == "undefined" || this.belowBlock == null || this.belowBlock.depthArray[i] == 0))
				{
				...
				if (this.is_container && (typeof(this.leftBlock) == "undefined" || this.leftBlock == null || this.leftBlock.depthArray[i] == 0))
				{
				...
				//if (!this.is_container || (this.isPlaced && !this.isHighestBlock && (typeof(this.aboveBlock) == "undefined" || this.aboveBlock == null || this.aboveBlock.depthArray[i] == 0)))
				if (!this.is_container || (typeof(this.aboveBlock) == "undefined" || this.aboveBlock == null || this.aboveBlock.depthArray[i] == 0))
				{
				...
				if (!this.is_container || typeof(this.rightBlock) == "undefined" || this.rightBlock == null || this.rightBlock.depthArray[i] == 0)
				{

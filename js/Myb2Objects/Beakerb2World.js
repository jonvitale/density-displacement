(function (window)
{
	...
	p.initialize = function (width_px, height_px, world_dx, world_dy, beaker_width_px, beaker_height_px, beaker_depth_px, view_sideAngle, view_topAngle, water_volume_perc, fluid_density)
	{
		...
		beakerLeftWallFixture.friction = 0.5;
		...
		beakerLeftWallBodyDef.position.x = (this.world_dx + this.width_px / 2 - this.beaker_width_px / 2) / SCALE;
		...
		beakerRightWallWallFixture.friction = 0.5;
		...
		beakerRightWallWallBodyDef.position.x = (this.world_dx + this.width_px / 2 + this.beaker_width_px / 2) / SCALE;
